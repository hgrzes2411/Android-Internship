...
@Composable
private fun toDisplayName(category: CategoryUi): String {
    return when (category) {
        CategoryUi.CATEGORY1 -> stringResource(id = R.string.category_1)
        CategoryUi.CATEGORY2 -> stringResource(id = R.string.category_2)
        CategoryUi.CATEGORY3 -> stringResource(id = R.string.category_3)
    }
}
